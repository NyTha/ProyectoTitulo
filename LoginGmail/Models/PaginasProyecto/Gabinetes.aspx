<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gabinetes.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.Gabinetes" %>
...
#svgabo2{
       background-image:url("gabinetes/gabo2.png") ;
       background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:290px;
...
#svgabo3{
       background-image:url("gabinetes/gabo3.png") ;
        background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
...
<h3>Gabinetes </h3>
      ...
      <div class="col">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg id="svgabo2"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_gabo2.aspx" class="link-dark text-decoration-none "><p class="card-text">Cooler Master Cosmos C700P Black Edition</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                   
                </div>
                    <b><small class="text-muted">Precio $ 50.990</small></b>
              </div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card shadow-sm">
            <svg id="svgabo3"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_gabo3.aspx" class="link-dark text-decoration-none "><p class="card-text">Gabinete Gamer Aerocool Cronus, Midi-Tower, Vidrio Templado, E-ATX/ATX/Micro-ATX/Mini-ITX</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                
                </div>
                <b><small class="text-muted">Precio $ 39.990</small></b>
              </div>
            </div>
          </div>
        </div>
