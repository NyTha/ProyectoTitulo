<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Discos.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.WebForm3" %>
...
<html lang="en">
  <head>
    ...
    <title>LTDR - Almacenamiento </title>
   ...
   #smof {
    ...
    #alm1{
     ...
     #alm2{
      ...
      #alm3{
       background-image:url("almacenamiento/alm1.png") ;
       background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
...
<div class="container-fluid">
 ...
 <div class="collapse" id="home-collapse">
      ...
      <li class="mb-1">
        <button id="btn_categoria" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
          Categorias
        </button>
...
<h3>Almacenamiento </h3>
      ...
      <div class="col">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg id="alm3"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_disco3.aspx" class="link-dark text-decoration-none "><p class="card-text">Unidad SSD Kingston SSDNow A400 240GB, 2.5", Lectura 500MB/s Escritura 350MB/s</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                
                </div>
                <b><small class="text-muted">Precio $ 38.980</small></b>
              </div>
            </div>
          </div>
        </div>
