<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proces.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.Proces" %>
   ...
   #smof {
    ...
    #cpu1{
     ...
     #cpu2{
      ...
      #cpu3{
       background-image:url("proces/cpu3.png") ;
       background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
...
<h3>Procesadores </h3>
      ...
      <div class="col">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg id="cpu3"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
               <a href="interfazproductos/int_proce3.aspx" class="link-dark text-decoration-none "><p class="card-text">AMD Ryzen 3 3200G</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                
                </div>
                <b><small class="text-muted">Precio $119.990</small></b>
              </div>
            </div>
          </div>
        </div>
