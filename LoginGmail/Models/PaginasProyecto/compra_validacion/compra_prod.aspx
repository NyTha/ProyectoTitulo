<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compra_prod.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.compra_validacion.WebForm1" %>
...
<div class="container-fluid">
  ...
  <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
    ...
    <form action="valid_prod.aspx">
   <div class="px-4 py-5 my-5 text-center">

    <h1 class="display-5 fw-bold">Valida tus Datos</h1>
       <h3 class="display-5">Datos del Comprador</h3>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">
          <b>Nombre</b>‏ㅤㅤ<input type="text" placeholder="Ingrese su Nombre"/ required>
          <br />
          <br />
          <b>Apellido</b>‏ㅤㅤ<input type="text" placeholder="Ingrese su Apellido"/>
          <br />
          <br />
          <b>RUT</b>‏ㅤㅤㅤㅤ<input type="text" placeholder="Ingrese su RUT" required/>
          <br />
          <br />
          <b>E-mail</b>‏‏ㅤㅤ⠀<input type="email" placeholder="Ej: ejemplo@gmail.com" required/>
          <br />
          <br />
          <b>Telefono</b>ㅤㅤ‏<input type="text" placeholder="Ej:+56 9 1234 5678"/>
      </p>
        <h3 class="display-5">Direccion de Entrega</h3>
        <p class="lead mb-4">
             <b>Direccion</b>⠀⠀⠀<input type="text" placeholder="Ej: Nom. Pasaje #123" required/>
            <br />
            <br />
             <b>Comuna</b>⠀⠀⠀<select>
                                <option disabled selected="">Seleccione su Comuna</option>
            ...
            <br />
            <br />
            <b>Quien Recibe</b>⠀<input type="text" placeholder="Ingrese Nombre y Apellido" title="Nombre y Apellido de quien recibe el producto"/>

        </p>
        <h3 class="display-5">Medio de Pago</h3>
        <p class="lead mb-4">
            <input class="form-check-input flex-shrink-0" type="checkbox" value="" >
            <b>⠀<span>Webpay</span>⠀⠀⠀</b>
            <br />
            <input class="form-check-input flex-shrink-0" type="checkbox" value="" >
            <b>⠀<span>Transferencia</span></b>
        </p>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <button id="btncomp" type="submit" class="btn btn-primary btn-lg px-4 gap-3">Pagar</button>
      </div>
    </div>
  </div>
    </form>
