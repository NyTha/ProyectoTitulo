<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaOfertas.aspx.cs" Inherits="ProyectoTitulo.WebForm3" %>
   ...
   #svgabo1{
      ...
      background-position-x:center;
       ...
       height:215px;  
        ...
        #alm2{
       background-image:url("almacenamiento/alm3.png") ;
       background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
        ...
        background-position-y:center;
             ...
             #mem3{
       background-image:url("ram/ram3.png") ;
      background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:265px;
     ...
     background-position-x:center;
       ...
       height:240px;
        background-size:contain;
            ...
            #cpu2{
       background-image:url("proces/cpu2.png") ;
      background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:265px;
...
<h3>Las Mejores Ofertas !! </h3>
      ...
      <div class="col">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg id="alm2"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_disco2.aspx" class="link-dark text-decoration-none "><p class="card-text">Unidad Estado Solido Crucial P5, M.2 NVMe, 250GB, PCI-e x4</p></a>
              <div class="d-flex justify-content-between align-items-center">
                     <small id="smof" class="text-muted">40% DCTO <del>$ 52.990</del></small>
                    <b><small class="text-muted">Precio Oferta $ 31.794</small></b>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card shadow-sm">
            ...
            <svg id="mem3"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_ram3.aspx" class="link-dark text-decoration-none "><p class="card-text">Memoria RAM LEXAR RGB de 8GB</p></a>
              <div class="d-flex justify-content-between align-items-center">
              <small id="smof" class="text-muted">20% DCTO <del>$ 51.072</del></small>
                 <b><small class="text-muted">Precio Oferta $ 38.304</small></b>
    ...
    <div class="col">
          <div class="card shadow-sm">
            <svg id="cpu2"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_proce2.aspx" class="link-dark text-decoration-none "><p class="card-text">Procesador Intel Core i3-12100F Alder Lake</p></a>
              <div class="d-flex justify-content-between align-items-center">
            <small id="smof" class="text-muted">25% DCTO <del>$ 119.168</del></small>       
                    <b><small class="text-muted">Precio Oferta $ 89.376</small></b>
              </div>
            </div>
          </div>
        </div>
