<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaPrincipal.aspx.cs" Inherits="ProyectoTitulo.WebForm2" %>
...
#titpagina{
  ...
  #logopw{
     ...
     background-position-x:center;
       ...
       height:240px;
        background-size:contain;
          ...
          #mem2{
       background-image:url("ram/ram2.png") ;
     background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
        ...
        background-position-y:center
              ...
              #alm1{
       background-image:url("almacenamiento/alm22.png") ;
       background-position-x:center;
       background-position-y:center;
       background-repeat:no-repeat;
       width:95%;
    ...
    #cpu1{
       background-image:url("proces/cpu1.png") ;
       background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:240px;
      ...
      background-position-x:center;
       ...
       #svgabo1{
       background-image:url("gabinetes/gaboo1.png") ;
      background-position-x:center;
       background-repeat:no-repeat;
       width:95%;
       height:190px;  
...
<div class="container-fluid">
    <div class="row">
        <div id="sdbar" class="col-2">
  <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
      
    <ul class="list-unstyled ps-0">
      <li class="mb-1">
        <button id="btn_inicio" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed btn_inicio" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
          Inicio
        </button>
      ...
      <li class="mb-1">
        <button id="btn_categorias" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed btnsdb2" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
          Categorias
        </button>
...
<h3>Recomendados </h3>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <svg id="svvg3"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img"  preserveAspectRatio="xMidYMid slice" focusable="false"></svg>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <svg id="mem2"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_ram2.aspx" class="link-dark text-decoration-none "><p class="card-text">Memoria RAM Kingston FURY Beast de 16GB</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                   
                </div>
                    <b><small class="text-muted">Precio $ 83.904</small></b>
              </div>
            </div>
          </div>
        </div>
         <div class="col">
          <div class="card shadow-sm">
            <svg id="alm1"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_disco1.aspx" class="link-dark text-decoration-none "><p class="card-text">Unidad Estado Solido Lexar NM620, 512GB, NVMe, M.2 2280</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  
                </div>
         <b><small class="text-muted">Precio $ 48.590</small></b>
              </div>
            </div>
          </div>
        </div>
       <div class="col">
          <div class="card shadow-sm">
            <svg id="cpu1"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_proce1.aspx" class="link-dark text-decoration-none "><p class="card-text">Procesador Intel Celeron G6900 Alder Lake</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  
                </div>
         <b><small class="text-muted">Precio $ 61.408</small></b>
              </div>
            </div>
          </div>
        </div>
   <div class="col">
         ...
         <div class="col">
          <div class="card shadow-sm">
            <svg id="svgabo1"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
              <a href="interfazproductos/int_gabo1.aspx" class="link-dark text-decoration-none "><p class="card-text">Gabinete Gamer Thermaltake AH T200, Micro-Case, Micro-ATX, Mini-ITX, Vidrio templado</p></a>
              <div class="d-flex justify-content-between align-items-center">
             <small id="smof" class="text-muted">40% DCTO <del>$ 166.780</del></small>
              <b><small class="text-muted">Precio Oferta $ 100.068</small></b>
              </div>
            </div>
          </div>
        </div>
