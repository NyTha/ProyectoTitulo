<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemRam.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.MemRam"%>
<!DOCTYPE html>
...
.btn-toggle[aria-expanded="true"]::before {
  transform: rotate(90deg);
     ...
     #mem1{
       background-image:url("ram/ram1.png") ;
...
<h3>Memorias RAM </h3>
      ...
      <div class="col">
          <div class="card shadow-sm">
            <svg id="mem1"class="bd-placeholder-img card-img-top" width="50%" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"></svg>

            <div class="card-body">
               <a href="interfazproductos/int_ram1.aspx" class="link-dark text-decoration-none "><p class="card-text">Memoria RAM Adata Premier de 8GB</p></a>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  
                </div>
         <b><small class="text-muted">Precio $ 45.600</small></b>
              </div>
            </div>
          </div>
        </div>
