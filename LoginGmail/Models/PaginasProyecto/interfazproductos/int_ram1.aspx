<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_ram1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm4" %>
...
<html lang="en">
  <head>
    ...
    <title>Memoria RAM Adata Premier de 8GB
...
<img id="imgprod" src="../ram/ram_int_ram1.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Memoria RAM Adata Premier de 8GB</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: ADATA</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 45.600</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ $ 55.600</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
                - Fabricante: ADATA
              <br />
                - Gama de productos: ADATA Premier Series
              <br />
                - Capacidad de almacenamiento: 8 GB , 8 GB
              <br />
                - Comprobación integridad: datos No ECC
              <br />
                - Especificación de memoria: PC4-25600
              <br />
                - Factor de forma: SO-DIMM de 260 contacto
