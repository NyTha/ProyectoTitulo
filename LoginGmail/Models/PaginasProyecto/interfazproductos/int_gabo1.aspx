<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_gabo1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm1" %>
...
<html lang="en">
  <head>
    ...
    <title>Gabinete Gamer Thermaltake AH T200, Micro-Case, Micro-ATX, Mini-ITX, Vidrio templado
...
<img id="imgprod" src="../gabinetes/img_gab1.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Gabinete Gamer Thermaltake AH T200, Micro-Case, Micro-ATX, Mini-ITX, Vidrio templadoNotebook 240 G8 14" HD Celeron N4020 4GB 500GB Windows 10</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: THERMALTAKE</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
             <p class="fs-6">Normal <del>$ 166.780</del></p>
             <p id="parrafos">40% DCTO</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 100.068</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 120.068</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            ...
            <br />
            - Tamaño máximo de placa madre: Micro ATX
            <br />
            ...
            - Iluminación: No
            <br />
            - Tamaño: 551 x 442 x 282 mm.
            <br />
            - Largo máximo de tarjeta de video: 320 mm
