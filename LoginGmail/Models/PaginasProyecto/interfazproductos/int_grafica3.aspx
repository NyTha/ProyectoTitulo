<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_grafica3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm9" %>
...
<html lang="en">
  <head>
    ...
    <title>Tarjeta de Video EVGA GeForce RTX 2060 SC GAMING de 6GB GDDR6
...
<img id="imgprod" src="../video/gpu3.png" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Tarjeta de Video EVGA GeForce RTX 2060 SC GAMING de 6GB GDDR6</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: EVGA</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 464.240</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 485.240</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
                - RTX 2060 GAMING EVGA 6GB GDDR6
                <br />
                - P/N: 06G-P4-2062-KR
                <br />
                ...
                - CUDA Cores: 1920
                <br />
                - Tipo de Bus: PCIe 3.0
                <br />
                - Detalle de Memoria: 6144MB GDDR6
                <br />
                - Ancho de Bit de Memoria: 192 Bit
                <br />
