<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_proce2.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm11" %>
...
<html lang="en">
  <head>
    ...
    <title>Procesador Intel Core i3-12100F Alder Lake
...
<img id="imgprod" src="../proces/int_img_proce2.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Procesador Intel Core i3-12100F Alder Lake</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: INTEL</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <p class="fs-6">Normal <del>$ 119.168</del></p>
          <p id="parrafos">25% DCTO</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 89.376</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 99.576</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            ...
            <br /> 
            - Nucleos/Hilos: 4 núcleos y 8 hilos
            <br />
            - Velocidad de reloj de núcleo P de 3,3 GHz
            <br />
            - Frecuencia turbo máxima: 4,3 GHz
            <br />
            - Socket: LGA 1700
            <br />
            - Memoria Cache: 12MB
