<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_note1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm1" %>
...
<html lang="en">
  <head>
    ...
    <title>Notebook 240 G8 14" HD Celeron N4020 4GB 500GB Windows 10
...
<div class="container py-2">
 ...
 <img id="imgprod" src="../notes/note1.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Notebook 240 G8 14" HD Celeron N4020 4GB 500GB Windows 10</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: HP</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 139.990</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 159.990</p></b>
        ...
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            - Procesador: INTEL Celeron
              <br />
            - Modelo Procesador: N4020
              <br />
            - Velocidad Procesador: 1,1GHz, hasta 2,8GHz
              <br />
            - Cantidad Nucleos: Dual Core
              <br />
