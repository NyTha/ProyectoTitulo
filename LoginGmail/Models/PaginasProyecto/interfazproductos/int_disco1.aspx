<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_disco1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm4" %>
...
<html lang="en">
  <head>
    ...
    <title>Unidad Estado Solido Lexar NM620, 512GB, NVMe, M.2 2280
...
<img id="imgprod" src="../almacenamiento/img_disk_1.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Unidad Estado Solido Lexar NM620, 512GB, NVMe, M.2 2280</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: LEXAR</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 58.590</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 48.590</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            ...
            <br />
            - Lectura secuencial: 3300MB/s
            <br /> 
            - Escritura secuencial: 3000MB/s
            <br />
            - IOPS: hasta 300/256 K / 200/256 K
            <br />
