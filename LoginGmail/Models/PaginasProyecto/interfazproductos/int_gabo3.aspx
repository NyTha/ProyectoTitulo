<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_gabo3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm3" %>
...
<html lang="en">
  <head>
    ...
    <title>Gabinete Gamer Aerocool Cronus, Midi-Tower, Vidrio Templado, E-ATX/ATX/Micro-ATX/Mini-ITX
...
<img id="imgprod" src="../gabinetes/img_gab3.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Gabinete Gamer Aerocool Cronus, Midi-Tower, Vidrio Templado, E-ATX/ATX/Micro-ATX/Mini-ITX</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: AEROCOOL</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 39.990</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 43.990</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            - Modelo: Cronus-G-BK-v1
            <br />
            - Tipo de caja: Torre media
            <br />
            - Color: negro
            <br />
            - Material del cuerpo: SPCC
            <br />
            - Material del panel frontal: ABS + acero
            <br />
            - Densidad de acero: 0,7 mm
            <br />
            - Placas base: E-ATX/ATX/micro ATX/mini-ITX
            <br />
            - Dimensiones de la caja (internas): 230 x 470 x 390 mm (ancho x alto x profundidad)
            <br />
            - Dimensiones de la caja (totales): 230 x 502 x 468 mm (ancho x alto x profundidad)
