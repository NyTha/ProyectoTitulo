<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_grafica2.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm8" %>
...
<html lang="en">
  <head>
    ...
    <title>Tarjeta de Video ASUS TUF Gaming GeForce GTX 1660 Ti EVO de 6GB GDDR6
...
<header>
  <div class="collapse bg-dark" id="navbarHeader">
    ...
    <div class="container">
     ...
     <a href="/Models/PaginasProyecto/.aspx" class="navbar-brand d-flex align-items-center">
...
<img id="imgprod" src="../video/gpu2.2.png" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Tarjeta de Video ASUS TUF Gaming GeForce GTX 1660 Ti EVO de 6GB GDDR6</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: ASUS</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
            <p class="fs-6">Normal <del>$ 432.896</del></p>
             <p id="parrafos">25% DCTO</p>
          <b><p id="precioprod" class="fs-6">Transferencia $324.672</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $354.672</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            ...
            <br />
            - Modo Gaming (Default): GPU Boost Clock : 1815 MHz , GPU Base Clock : 1530 MHz
            <br />
            - CUDA Core: 1408
            <br />
            ...
            <br />
            - Resolucion: Digital Max Resolution 7680 x 4320
