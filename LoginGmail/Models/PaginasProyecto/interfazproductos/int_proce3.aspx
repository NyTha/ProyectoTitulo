<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_proce3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm12" %>
...
<img id="imgprod" src="../proces/int_img_proce3.PNG" />
      </div>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            - Frecuencia: 3600 MHz
            <br />
            - Frecuencia turbo máxima: 4000 MHz
            <br />
            - Núcleos/Hilos: 4 núcleos / 4 hilos
            <br />
            - Caché: 4 x 512KB L2 / 4MB L3
            <br />
            - Socket: AM4
            <br />
            - Núcleo: AMD Picasso (Zen+)
            <br />
            - Proceso de manufactura: 12 nm
            <br />
            - TDP: 65 W
            <br />
