<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_disco3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm6" %>
...
<html lang="en">
  <head>
    ...
    <title>Unidad SSD Kingston SSDNow A400 240GB, 2.5", Lectura 500MB/s Escritura 350MB/s
...
<img id="imgprod" src="../almacenamiento/img_disk_3.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Unidad SSD Kingston SSDNow A400 240GB, 2.5", Lectura 500MB/s Escritura 350MB/s</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: KINGSTON</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 38.980</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 49.980</p></b>
