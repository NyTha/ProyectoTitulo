<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_gabo2.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm2" %>
...
<html lang="en">
  <head>
    ...
    <title>Cooler Master Cosmos C700P Black Edition
...
<img id="imgprod" src="../gabinetes/img_gab2.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Cooler Master Cosmos C700P Black Edition</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: COOLER MASTER</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 50.990</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 57.990</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
                - Número de modelo: MCC-C700P-KG5N-S00
                <br />
                - Serie: COSMOS Serie
                <br />
                - Tamaño: Torre Completa
                <br />
                - Color: Negro
                <br />
                - Materiales: Acero, Vidrio templado curvo
                <br />
                - Dimensiones: (L x An x Al) 639 x 306 x 651 mm
                <br />
                - Peso: 22,2 kg
                <br />
                - Compatibilidad con placa base: E-ATX, ATX, Micro ATX, Mini ITX
                <br />
                - Panel: E/S 4x USB 3.0, 1x USB 3.1 Gen 2 Type-C, 1x conector de audio de 3,5 mm, 1x conector de micrófono de 3,5 mm, velocidad del ventilador, botones de control RGB
