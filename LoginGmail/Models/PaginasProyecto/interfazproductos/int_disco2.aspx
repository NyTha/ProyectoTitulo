<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_disco2.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfazproductos.WebForm5" %>
...
<html lang="en">
  <head>
    ...
    <title>Unidad Estado Solido Crucial P5, M.2 NVMe, 250GB, PCI-e x4
...
<img id="imgprod" src="../almacenamiento/img_disk_2.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Unidad Estado Solido Crucial P5, M.2 NVMe, 250GB, PCI-e x4</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: CRUCIAL</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
            <p class="fs-6">Normal <del>$ 52.990</del></p>
             <p id="parrafos">40% DCTO</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 31.794</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 41.694</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            - Crucial P5 250GB M.2 2280 3D NAND NVMe PCIe
            <br />
            - Serie SSD: P5
            <br />
            - Interfaz: NVMe (PCIe Gen 3 x4) 
            <br />
            - Capacidad: 250GB 
            <br />
            ...
            <br />
            - Resistencia SSD (TBW): 150 Terabytes
