<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_ram3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm6" %>
...
<html lang="en">
  <head>
    ...
    <title>Memoria RAM LEXAR RGB de 8GB
...
<img id="imgprod" src="../ram/ram_int_ram3.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Memoria RAM LEXAR RGB de 8GB</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: LEXAR</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
            <p class="fs-6">Normal <del>$ 51.072</del></p>
             <p id="parrafos">20% DCTO</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 38.304</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 49.304</p></b>
    ...
    - Velocidad: 3200Mbps
              <br />
    - Estándar: JEDEC / XMP 2.0
              <br />
    - Latencia: CAS CL19 / CL16-18-18-38 (3200)
              <br />
    - Voltaje: 1.2V / 1.35V
              <br />
    - Temperatura de funcionamiento: -20°C a 85°C (Superficie)
              <br />
    - Temperatura de conservación: -55°C a 100°C
