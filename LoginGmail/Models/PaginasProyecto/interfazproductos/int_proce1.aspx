<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_proce1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm10" %>
...
<html lang="en">
  <head>
    ...
    <title>Procesador Intel Celeron G6900 Alder Lake
...
<img id="imgprod" src="../proces/int_img_proce1.PNG" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Procesador Intel Celeron G6900 Alder Lake</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: INTEL</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 61.408</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 65.608</p></b>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            ...
            <br /> 
            - Nucleos/Hilos: 2 núcleos y 2 hilos
            <br />
            ...
            - Memoria caché: 4 MB
            <br />
            - Memoria DDR5 de doble canal
            <br />
            - Gráficos integrados: Intel UHD 710
            <br />
