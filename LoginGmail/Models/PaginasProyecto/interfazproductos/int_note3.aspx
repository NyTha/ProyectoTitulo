<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_note3.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm3" %>
...
<html lang="en">
  <head>
    ...
    <title>Notebook Galaxy Book2 15.6" FHD Intel i5-1235U 8GB 512GB SSD Windows 11 Silver
...
<img id="imgprod" src="../notes/note%2033.png" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Notebook Galaxy Book2 15.6" FHD Intel i5-1235U 8GB 512GB SSD Windows 11 Silver</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: Samsung</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <p class="fs-6">Normal <del>$ 529.990</del></p>
             <p id="parrafos">20% DCTO</p>
            <b><p id="precioprod" class="fs-6">Transferencia $ 400.990</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 423.992</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
       ...
       - Procesador: INTEL Core i5
              <br />
       - Modelo Procesador: 1235U
              <br />
       - Velocidad Procesador: 1.3GHz hasta 4.4GHz
              <br />
       - Cantidad Nucleos: Deca Core (10 nucleos)
              <br />
       - Memoria RAM Incluida: 8GB
              <br />
       - Memoria RAM máxima soportada: 8GB
              <br />
