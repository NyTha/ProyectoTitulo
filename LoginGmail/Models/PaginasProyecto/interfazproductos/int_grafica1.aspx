<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_grafica1.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm7" %>
...
<html lang="en">
  <head>
    ...
    <title>Tarjeta de Video ASUS Dual GeForce GTX 1650 MINI de 4GB GDDR6
...
<img id="imgprod" src="../video/gpu1.1.png" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Tarjeta de Video ASUS Dual GeForce GTX 1650 MINI de 4GB GDDR6</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: ASUS</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 239.552</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 259.552</p></b>
    ...
    <ul class="border-top my-3"></ul>
      ...
      <div class="col-md-6">
        <div id="tar_espef" class="h-100 p-5 text-dark rounded-3">
          ...
          <p>
            - Conjunto de chips: NVIDIA GeForce GTX 1650
            <br />
            - Reloj base: TBD MHz (modo OC); TBD MHz 
            <br />
            - Reloj Boost: TBD MHz (Modo OC); TBD MHz 
            <br />
            - Memoria de vídeo: 4GB GDDR5
            <br />
            - Reloj de memoria: TBD MHz
            <br />
            - Interfaz de memoria: 128 bits
            <br />
            - Autobús: PCI-Express 3.0
            <br />
            - Núcleos CUDA: 896
            <br />
            - RAMDAC: 400 MHz
            <br />
            - Resolución Max: 7680 x 4320, admite monitores de pantalla 3x
