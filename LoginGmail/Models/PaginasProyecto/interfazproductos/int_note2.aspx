<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="int_note2.aspx.cs" Inherits="LoginGmail.Models.PaginasProyecto.interfaz_productos.WebForm2" %>
...
<html lang="en">
  <head>
    ...
    <title>Notebook 240 G8 14" HD Intel i3-1005G1 4GB 1TB Windows 10 Dark Gray
...
<img id="imgprod" src="../notes/note%2022.png" />
      </div>

      <div class="col-md-5 py-0">
        <div class="h-150 p-5 bg-light">
          <h3>Notebook 240 G8 14" HD Intel i3-1005G1 4GB 1TB Windows 10 Dark Gray</h3>
           <ul class="border-top my-3"></ul>
          <p>Marca: HP</p>
          <p id="parrafos">Stock: 10 Productos Disponibles</p>
          <b><p id="precioprod" class="fs-6">Transferencia $ 279.990</p></b>
          <b><p id="precioprod" class="fs-6">Otros Medios de Pago $ 300.990</p></b>
    ...
    - Procesador: INTEL Core i3
              <br />
    - Modelo Procesador: 1005G1
              <br />
    - Velocidad Procesador: 1.2GHz hasta 3.4GHz
              <br />
    - Memoria RAM Incluida: 4GB
              <br />
    - Memoria RAM máxima soportada: 16GB
              <br />
    - Velocidad de Memoria: RAM DDR4 2666MHz
              <br />
